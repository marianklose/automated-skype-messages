...
# define user message
user_msg = f'Please generate a very short reminder to clean the coffee machine. Please use these two words somewhere in the sentence to refer to a dirty machine: {coffee_dirty_words_sample}. Make the volunteering more attractive by describing it with {glory_fame_words_sample}. End it by refering to the picture I sent directly before that (which is a dirty coffee machine). Remember: Be short!'
